// src/components/layout/DirecteurLayout.jsx
...
const menuItems = [
  { text: 'Tableau de bord', icon: <DashboardIcon />, path: '/directeur/dashboard' },
  { text: 'Matériels affectés', icon: <ComputerIcon />, path: '/directeur/materiels' },
  { text: 'Besoins', icon: <AssignmentIcon />, path: '/directeur/besoins' },
  { text: 'Pannes', icon: <BuildIcon />, path: '/directeur/pannes' },
];
...
export default function DirecteurLayout() {
  ...
  const getPageTitle = () => {
    ...
    return currentItem ? currentItem.text : 'Espace Directeur';
  };
